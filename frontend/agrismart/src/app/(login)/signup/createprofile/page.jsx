...
export default function CreateProfile() {
  ...
  const uploadProfilePicture = async (imageData) => {
    try {
      await profileAPI.uploadProfilePicture({ image: imageData });
    ...
    return (
      <div className="min-h-screen bg-white flex items-center justify-center p-4">
        <div className="text-center">
          ...
          <h2 className="text-2xl font-bold text-secondary mb-2">Profile Created Successfully!</h2>
          <p className="text-gray-500 mb-6">Your profile has been created. Click below to continue.</p>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    className={`w-full px-4 py-3 border ${errors.fullName ? 'border-red-500' : 'border-gray-200'} rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all`}
                  />
                ...
                <div>
                  ...
                  <input
                    ...
                    className={`w-full px-4 py-3 border ${errors.birthday ? 'border-red-500' : 'border-gray-200'} rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all`}
                  />
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    className={`w-full px-4 py-3 border ${errors.nicNumber ? 'border-red-500' : 'border-gray-200'} rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all`}
                  />
                  {errors.nicNumber && <p className="text-xs text-red-500 mt-1">{errors.nicNumber}</p>}
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows="3"
                    className={`w-full px-4 py-3 border ${errors.address ? 'border-red-500' : 'border-gray-200'} rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all`}
                  />
                ...
                <div>
                  ...
                  <select
                    ...
                    className={`w-full px-4 py-3 border ${errors.district ? 'border-red-500' : 'border-gray-200'} rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all`}
                  >
